...
1. Getting started in R (19 OCT 2022)
2. General computing concepts (02 NOV 2022)
3. Writing and using functions (16 NOV 2022)
4. Writing and using loops (30 NOV 2022)
5. Simulating data in R (14 DEC 2022)
6. Introduction to version control (11 JAN 2023)
7. Slides in Rmarkdown (25 JAN 2023)
8. Manuscripts in Rmarkdown (08 FEB 2023)
9. Rshiny applications (22 FEB 2023)
10. Randomisation in R (08 MAR 2023)
11. Writing tests for code (22 MAR 2023)
12. Individual-based modelling (05 APR 2023)
13. Creating R packages (19 APR 2023)
...
\item \href{https://www.ibm.com/uk-en/products/spss-statistics}{SPSS}
\item \href{https://www.jamovi.org/}{Jamovi}
\end{itemize}
